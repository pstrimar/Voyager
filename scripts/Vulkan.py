...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.3.250.1/windows/vulkan_sdk.exe'
VOYAGER_VULKAN_VERSION = '1.3.250.1'
VULKAN_SDK_EXE_PATH = 'Voyager/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (VOYAGER_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Voyager requires {VOYAGER_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
VulkanSDKDebugLibsURL = 'https://files.lunarg.com/SDK-1.3.250.1/VulkanSDK-1.3.250.1-DebugLibs.zip'
OutputDirectory = "Voyager/vendor/VulkanSDK"
